...
import { Clipboard, RefreshCw, Cpu, Zap, Server, Smartphone, Check } from 'lucide-react';
          ...
          <div className="relative z-10 p-4 sm:p-6 md:p-8 lg:p-10">
            <div className="prose prose-amber max-w-none">
              <p className="text-stone-700/90 text-base sm:text-lg leading-relaxed mb-6 sm:mb-8">
                Clipboard Sync is a background service that works silently to keep your clipboard in sync across all your devices. 
