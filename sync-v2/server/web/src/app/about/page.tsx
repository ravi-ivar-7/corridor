...
import { Clipboard, Lock, Zap, Smartphone, Globe, ArrowLeft } from 'lucide-react';
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            A simple way to share text between your devices
          </p>
        </div>
                ...
                <div className="flex">
                  ...
                  <div className="ml-3">
                    <p className="text-sm text-slate-600">
                      This is a simple clipboard sharing tool. Any text you copy while on a token's page will be visible to anyone else using the same token.
                    </p>
                  </div>
                </div>
              </div>
