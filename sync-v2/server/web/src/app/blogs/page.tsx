...
import { Clipboard, Zap, Smartphone, ArrowRight, Search, Clock, Tag } from 'lucide-react';
...
export default function BlogPage() {
  ...
  const blogPosts: BlogPost[] = [
    {
      title: 'What is Clipboard Sync?',
      description: 'Learn about Clipboard Sync and how it can help you share text across your devices.',
    ...
    {
      title: 'How to Use Clipboard Sync',
      description: 'Step-by-step guide on setting up and using Clipboard Sync.',
      slug: 'how-to-use',
      category: 'Tutorial',
      readTime: '4 min read',
    ...
    {
      title: 'Use Cases for Clipboard Sync',
      description: 'Discover practical ways to use Clipboard Sync in your daily workflow and boost productivity.',
      slug: 'use-cases',
      category: 'Tips',
      readTime: '5 min read',
